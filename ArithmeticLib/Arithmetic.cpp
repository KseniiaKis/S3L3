...
TArithmetic::TArithmetic(TString expr)
{
  infix = expr;
  char opers[6] = { '(',')', '+', '-', '*', '/' };
...
TString TArithmetic::GetInfix()
{
  return infix;
}

TString TArithmetic::GetPostfix()
{
  return postfix;
}

TMap<char, double> TArithmetic::GetOperands()
{
  return operands;
}

void TArithmetic::SetOperands()
{
